...
<body class="bg-gray-100">
    <div class="py-3 bg-gray-800 shadow-lg">
        <h1 class="text-white text-2xl font-bold text-center">Manage Products</h1>
    </div>
            ...
            <div class="w-full max-w-5xl">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <div class="bg-gray-800 p-4 flex justify-between items-center">
                        ...
                        <a href="{{ route('products.create') }}" class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('products.edit', $product->id) }}" class="bg-blue-500 text-white py-1 px-2 rounded hover:bg-blue-600" title="Update">
                                                    <i class="fa fa-pen"></i>
                                                </a>
